...
enum class TermOfServiceType(val value: Int) {
    Text(0),
    SectionHeader(1),
    Header(2),
    Separator(3),
...
data class TermOfServiceString(
    val id: String = UUID.randomUUID().toString(),
    val type: TermOfServiceType,
    val content: String? = null,
    val indent: String? = null,
    val isPadding: Boolean = true
)

val termOfService: List<List<TermOfServiceString>> = listOf(
    listOf(
        TermOfServiceString(
            type = TermOfServiceType.SectionHeader,
            content = "キャリオク利用規約"
        ),
        TermOfServiceString(
            type = TermOfServiceType.Text,
        ...
        TermOfServiceString(
            type = TermOfServiceType.Separator
        ),
        TermOfServiceString(
            type = TermOfServiceType.Header,
            content = "第1条　キャリオク"
        ),
        TermOfServiceString(
            type = TermOfServiceType.TextIndent,
